  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {METRICS.map((m) => (
          <div key={m.key} className="rounded-xl border border-gray-200 bg-white p-5 text-center">
            <p className="text-xs font-medium text-gray-500 mb-1">{m.label}</p>
            <p className="text-3xl font-bold text-gray-900">{(m.value * 100).toFixed(1)}%</p>
